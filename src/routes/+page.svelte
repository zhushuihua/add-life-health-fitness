<script lang="ts">
    ...
    import Trainers from "./trainers/trainers.svelte";
    import Price from "./price/prices.svelte";
...
<Testimonials />
<Contact />
<div class="bg-zinc-950 text-white mt-16">
    <Container>
        <div class="py-4 flex flex-col gap-4 md:flex-row md:justify-between">
            <p>&copy; UMA Maths Learning centre 2024</p>
            <nav>
                <ul class="flex gap-4">
                    <li>
                        <a href="#"
